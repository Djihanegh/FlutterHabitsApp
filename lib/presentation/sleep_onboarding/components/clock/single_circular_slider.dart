...
import 'package:pavlok_test/presentation/sleep_onboarding/components/clock/slider_painter.dart';
...
class _CircularSliderState extends State<CircularSliderPaint> {
 ...
 Future<Unit8List> myBackground =  decodeImageFromList( Io.File(' AppAssets.bedTime') .readAsBytes());
      }*/
